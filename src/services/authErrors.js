...
const loginErrorMessages = {
  kr: {
    config: '로그인 서비스를 연결하지 못했습니다. 잠시 후 다시 시도해 주세요.',
  ...
  en: {
    config: 'The sign-in service is temporarily unavailable. Please try again shortly.',
  ...
  jp: {
    config: 'ログインサービスに接続できませんでした。しばらくしてからもう一度お試しください。',

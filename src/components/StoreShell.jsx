...
const footerInfo = {
  kr: {
    ...
    quoteTitle: '견적 안내',
    quoteLines: ['로그인 후 가격 확인 가능', '견적 리스트에서 상품 검토', '최종 거래 조건은 담당자 확인 후 안내'],
    snsTitle: 'SNS',
  ...
  en: {
    ...
    quoteLines: ['Price available after sign-in', 'Review items in Inquiry List', 'Final trade terms are confirmed by manager'],
    snsTitle: 'SNS',
    snsLines: ['Instagram', 'KakaoTalk', 'Noblesse updates'],
  ...
  jp: {
    ...
    quoteTitle: '見積案内',
    quoteLines: ['ログイン後に価格確認可能', 'お問い合わせリストで商品確認', '最終取引条件は担当者確認後に案内'],
    snsTitle: 'SNS',
    snsLines: ['Instagram', 'KakaoTalk', 'Noblesse updates'],
  ...
  cn: {
    ...
    quoteTitle: '詢價資訊',
    quoteLines: ['登入後可查看價格', '在詢價清單中查看商品', '最終交易條件由負責人確認後提供'],
    snsTitle: 'SNS',
    snsLines: ['Instagram', 'KakaoTalk', 'Noblesse updates'],
...
const loginModalCopy = {
  kr: {
    title: '거래처 로그인',
    heading: 'LOGIN',
    description: '등록한 거래처는 로그인 후 가격, 견적 리스트, 견적 요청 기능을 사용할 수 있습니다. 견적 요청은 최종 주문이 아닙니다.',
    email: '아이디 또는 이메일',
    password: '비밀번호',
  ...
  en: {
    title: 'Trade login',
    heading: 'LOGIN',
    description: 'Registered buyers can view prices, use Inquiry List, and request quotes after sign-in. A quote request is not a final order.',
    email: 'ID or email',
    password: 'Password',
    emailPlaceholder: 'Enter ID or email',
  ...
  jp: {
    title: '取引先ログイン',
    heading: 'LOGIN',
    description: '登録済みの取引先はログイン後に価格、お問い合わせリスト、見積依頼を利用できます。見積依頼は最終注文ではありません。',
    email: 'ID またはメール',
    password: 'パスワード',
    emailPlaceholder: 'ID またはメールを入力',
  ...
  cn: {
    title: '贸易登录',
    heading: 'LOGIN',
    description: '已確認的貿易客戶可使用交易條件、詢價清單和詢價請求。詢價請求不是最終訂單。',
    email: 'ID 或電子郵件',
    password: '密码',
    emailPlaceholder: '請輸入 ID 或電子郵件',

...
const registerCopy = {
  ...
  en: {
    ...
    helper: 'Reviewed members can access member prices, 최소 수량, Inquiry List, and Request Quote.',
  ...
  jp: {
    ...
    helper: '承認後、会員価格、최소 수량、Inquiry List、Request Quoteをご利用いただけます。',
  ...
  cn: {
    ...
    helper: '审核通过后，可使用会员价格、최소 수량、Inquiry List 和 Request Quote。',
    noticeTitle: '申请前请确认',
    noticeItems: [
      '会员审批将由人工审核。',
      '会员价格会在审批后开放。',

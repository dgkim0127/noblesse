...
const registerCopy = {
  kr: {
    ...
    helper: '거래처 계정을 등록하면 로그인 후 회원가, MOQ, 견적 리스트와 견적 요청 기능을 바로 이용할 수 있습니다.',
    noticeTitle: '문의 전 확인해주세요',
    noticeItems: [
      '거래처 계정 등록 후 가격과 견적 기능을 바로 이용할 수 있습니다.',
      '최종 재고, 가격, 납기와 공급 가능 수량은 견적 요청 후 담당자가 확인합니다.',
      '견적 요청은 최종 주문이 아닙니다.',
    ...
    approvalTitle: '계정 이용 안내',
    approvalBody: '등록을 완료하면 로그인 상태에서 가격 확인과 견적 요청 기능을 바로 이용할 수 있습니다.',
    orderDisclaimer: '견적 요청은 최종 주문이 아니며, 담당자 확인 후 거래 조건을 안내드립니다.',
  ...
  en: {
    ...
    helper: 'After registration, sign in to access member pricing, MOQ, Inquiry List, and Request Quote immediately.',
    noticeTitle: 'Before you inquire',
    noticeItems: [
      'Registered buyer accounts can use pricing and quote features after sign-in.',
      'Noblesse confirms final availability, price, lead time, and supply quantity after Request Quote.',
    ...
    approvalTitle: 'Account access',
    approvalBody: 'After registration, sign in to access pricing and Request Quote immediately.',
  ...
  jp: {
    ...
    helper: '取引先アカウント登録後、ログインすると会員価格、MOQ、見積リスト、見積依頼をすぐに利用できます。',
    noticeTitle: 'お問い合わせ前にご確認ください',
    noticeItems: [
      '登録済み取引先はログイン後すぐに価格と見積機能を利用できます。',
      '最終在庫、価格、納期、供給可能数量は見積依頼後に担当者が確認します。',
      '見積相談は最終確定ではありません。',
    ...
    approvalTitle: 'アカウント利用案内',
    approvalBody: '登録完了後、ログインすると価格確認と見積依頼をすぐに利用できます。',
  ...
  cn: {
    ...
    helper: '註冊買家帳戶後，登入即可使用會員價格、MOQ、詢價清單與報價詢問功能。',
    noticeTitle: '咨询前请确认',
    noticeItems: [
      '已註冊買家登入後即可使用價格與詢價功能。',
      '最終庫存、價格、交期與可供應數量將在提交詢價後由工作人員確認。',
      '詢價請求不是最終確認。',
    ...
    approvalTitle: '帳戶使用說明',
    approvalBody: '註冊完成後，登入即可查看價格並提交報價詢問。',
    orderDisclaimer: '詢價請求不是最終訂單。工作人員確認後會說明交易條件。',
...
const localizedAgreementSections = {
  terms_of_service: {
    kr: [
      ['제1조 목적', '본 약관은 귀족이 운영하는 Noblesse 웹사이트에서 제공하는 국내·해외 B2B 피어싱 카탈로그, 회원 가입, 거래처 확인, 상품 정보 열람, 견적 요청 및 관련 안내 서비스의 이용 조건과 절차를 정합니다.'],
      ['제2조 용어의 정의', ['이용자는 사이트에 접속하거나 서비스를 이용하는 모든 방문자와 회원을 의미합니다.', '회원은 회원 가입 절차를 통해 정보를 제출하고 귀족의 카탈로그 및 문의 서비스를 이용하는 개인 또는 사업자 담당자를 의미합니다.', '등록 회원은 로그인 후 회원가, MOQ, 견적 리스트와 견적 요청 기능을 이용할 수 있는 회원을 의미합니다.', '견적 요청은 상품, 옵션, 수량, 메모를 기준으로 거래 검토를 요청하는 절차이며 최종 주문이나 대금 확정이 아닙니다.']],
      ...
      ['제4조 서비스의 제공', ['귀족은 상품 이미지, 상품명, 상품 코드, 소재, 컬러, 사이즈, MOQ, 카테고리, 컬렉션, 카탈로그 안내, 회원 상태 안내, 견적 요청 관련 기능을 제공할 수 있습니다.', '서비스는 B2B 거래 검토를 돕기 위한 카탈로그 및 문의 기능이며, 온라인 대금 처리나 즉시 주문 확정을 목적으로 하지 않습니다.']],
      ['제5조 회원 가입 및 정보 제출', ['회원은 아이디, 비밀번호, 업체명, 담당자명, 연락처, 국가/지역, 판매 채널, 관심 상품, 문의 내용 등 거래 확인에 필요한 정보를 제출할 수 있습니다.', '회원은 가입 과정에서 사실과 다른 정보, 타인의 정보, 확인이 어려운 정보를 제출해서는 안 됩니다.', '제출 정보가 부정확하거나 추가 확인이 필요한 경우 회원가 안내, 거래 조건 안내, 견적 요청 이용이 보류될 수 있습니다.']],
      ...
      ['제9조 가격 및 거래 조건', ['회원가와 시장별 가격은 등록 회원이 로그인 후 확인할 수 있으며, 최종 재고, 납기, 배송 조건과 수출 조건은 견적 처리 과정에서 담당자가 확인합니다.', '사이트에 표시되는 정보 또는 문의 단계의 참고 가격은 최종 확정 조건이 아니며, 최종 조건은 귀족 담당자 확인 후 별도로 안내됩니다.']],
      ['제10조 견적 요청의 성격', ['견적 요청은 회원이 관심 상품과 수량을 기준으로 귀족에 검토를 요청하는 절차입니다.', '견적 요청 접수만으로 주문, 계약, 대금 처리나 배송 의무가 발생하지 않습니다.', '최종 가격, 가능 수량, 생산 가능 여부, 납기, 배송 조건은 담당자 확인 후 안내됩니다.']],
      ...
      ['제16조 문의 및 고지', '회원 가입, 약관, 개인정보, 카탈로그, 견적 요청과 관련한 문의는 사이트 안내 또는 지정 이메일 연락처를 통해 접수할 수 있습니다.'],
    ],
    en: [
      ['Service Purpose', 'Noblesse provides a B2B piercing catalog, sign-up, buyer review, and quote request features for domestic and international buyers.'],
      ...
      ['Pricing and Trade Terms', 'Registered members can view member and market pricing after sign-in. Final stock, lead time, shipping conditions, and MOQ are confirmed during quote processing. Screen information is not a final trade condition.'],
      ['Quote Request', 'A quote request is not a final order. It is a request for Noblesse to review selected products, options, and quantities for trade discussion.'],
      ...
      ['Contact Channel', 'Sign-up, catalog, quote request, and privacy-related inquiries may be received through site guidance or the designated email contact.'],
    ],
    jp: [
      ['サービスの目的', '貴族は国内外のB2Bバイヤー向けに、ピアスカタログ、会員登録、会員確認、見積依頼機能を提供します。'],
      ...
      ['価格および取引条件', '登録会員はログイン後に会員価格と市場別価格を確認できます。最終在庫、納期、配送条件、MOQは見積処理時に担当者が確認し、画面表示は最終条件を意味しません。'],
      ['見積依頼', '見積依頼は最終注文ではありません。選択した商品、オプション、数量をもとに貴族へ取引確認を依頼する手続きです。'],
      ...
      ['お問い合わせ窓口', '会員登録、カタログ、見積依頼、個人情報に関する問い合わせは、サイト内案内または指定メール連絡先で受け付けます。'],
    ],
    cn: [
      ['服務目的', '貴族為國內外B2B買家提供穿孔飾品目錄、會員註冊、會員審核和詢價請求功能。'],
      ...
      ['价格及交易条件', '已註冊會員登入後可查看會員價格與市場價格。最終庫存、交期、配送條件與 MOQ 由負責人在詢價處理時確認，頁面內容並非最終交易條件。'],
      ['詢價請求', '詢價請求不是最終訂單，而是根據所選商品、選項和數量向貴族請求交易確認的流程。'],
      ...
      ['聯絡管道', '會員註冊、目錄、詢價請求及個人資料相關問題可透過網站說明或指定信箱聯絡。'],
    ],
  },
  buyer_terms: {
    kr: [
      ['제1조 목적', '본 조건은 귀족 도매 회원의 확인 기준, 회원가 열람, MOQ, 견적 요청, 거래 조건 안내와 관련한 세부 이용 기준을 정합니다.'],
      ['제2조 도매 회원 계정', ['등록을 완료한 도매 회원은 로그인 후 가격과 견적 기능을 이용할 수 있습니다.', '최종 재고와 거래 가능 조건은 견적 요청을 처리하는 과정에서 담당자가 확인합니다.']],
      ['제3조 회원 상태', ['회원 상태는 비회원, 활성 회원, 제한 회원, 관리자 등으로 구분될 수 있습니다.', '활성 회원은 로그인 후 회원가와 견적 기능을 이용하며, 허위 정보나 서비스 오용이 확인된 계정은 이용이 제한될 수 있습니다.']],
      ['제4조 회원가 및 시장별 가격', ['회원가와 시장별 가격은 로그인한 활성 회원에게 안내될 수 있습니다.', '가격은 통화, 국가, 시장, 공급 조건, 수출 가능 여부, 원자재 가격, 생산 상황에 따라 달라질 수 있습니다.']],
      ['제5조 MOQ 및 옵션', ['MOQ는 상품, 소재, 컬러, 사이즈, 생산 조건, 시장별 공급 정책에 따라 달라질 수 있습니다.', '사이트에 표시되는 MOQ는 검토 기준이며 실제 견적 과정에서 조정될 수 있습니다.']],
      ['제6조 견적 요청', ['견적 요청은 선택한 상품과 수량에 대한 검토 요청입니다.', '견적 요청은 최종 주문, 대금 처리, 계약 체결을 의미하지 않으며, 귀족 담당자의 확인 후 별도 안내됩니다.']],
      ['제7조 정보 정확성', ['회원은 계정 운영과 견적 응대에 필요한 정보를 정확하게 제출해야 합니다.', '허위 정보, 누락 정보, 연락 불가, 확인이 어려운 정보가 있는 경우 계정 이용이 제한되거나 견적 안내가 지연될 수 있습니다.']],
      ['제8조 가격 정보 보호', ['회원가, 시장별 가격, 견적 내용, 공급 조건은 등록 회원의 거래 검토를 위한 정보입니다.', '귀족의 사전 동의 없이 가격 정보나 견적 내용을 외부에 공유하거나 공개해서는 안 됩니다.']],
      ['제9조 거래 가능성', '귀족은 상품 공급 상황, 생산 가능 여부, 수출 가능 여부, 거래 지역, 물류 조건, 내부 운영 정책에 따라 거래 가능 여부를 판단할 수 있습니다.'],
      ['제10조 계정 이용 제한', '부정확한 정보, 무단 가격 공유, 서비스 오용, 거래 질서 저해 행위가 확인되는 경우 귀족은 회원 계정 이용을 제한할 수 있습니다.'],
    ],
    en: [
      ['Member Account', 'Registered wholesale members can use member pricing, MOQ, Inquiry List, and Request Quote after sign-in.'],
      ['Member Price and Terms', 'Member pricing, MOQ, and market pricing may be provided to signed-in active members. Final trade terms are confirmed during quote processing.'],
      ['Nature of Quote Request', 'A quote request is a review request for selected products and quantities, not a final transaction.'],
      ['Information Accuracy', 'Account access may be restricted or quote guidance delayed if submitted information is inaccurate or difficult to verify.'],
    ],
    jp: [
  ...
  privacy_collection_use: {
    kr: [
      ['[필수] 개인정보 수집·이용 동의', {
        ...
        rows: [
          ...
          ['견적 요청 응대 및 거래 조건 안내', '연락처, 문의 상품, 수량, 요청 메모, 담당자 응대 기록', '문의 처리 완료 후 내부 기록 보존 기간까지'],
      ...
      ['동의 거부 권리', ['회원은 개인정보 수집·이용에 동의하지 않을 권리가 있습니다.', '다만 필수 항목에 동의하지 않는 경우 회원 가입, 거래처 확인, 견적 요청 처리가 제한될 수 있습니다.', '선택 항목에 동의하지 않아도 회원 가입 신청은 가능합니다.']],
    ...
    en: [
      ...
      ['Refusal of Consent', 'If required privacy consent is refused, sign-up and quote request processing may be limited.'],
    ],
    jp: [
      ...
      ['同意拒否', '必須の個人情報収集・利用に同意しない場合、会員登録および見積依頼の処理が制限されることがあります。'],
    ],
    cn: [
      ...
      ['拒絕同意', '如不同意必要的個人資料蒐集與使用，會員註冊和詢價請求處理可能受到限制。'],
    ],
  },
  marketing_updates: {
    kr: [
...
const localizedAgreementDetailOverrides = {
  terms_of_service: {
    en: [
      ['Article 1 Purpose', 'These terms define the conditions for Noblesse sign-up, buyer review, product catalog browsing, quote request, and related B2B guidance services.'],
      ['Article 2 Definitions', ['User means any visitor or member who accesses the site or uses the service.', 'Member means an individual or business representative who submits information through the sign-up process and uses the Noblesse catalog or inquiry service.', 'Registered buyer means a member who can access member pricing, MOQ guidance, and quote request features after sign-in.', 'Quote request means a request for trade review based on products, options, quantities, and notes. It is not a final trade confirmation.']],
      ...
      ['Article 4 Services Provided', ['Noblesse may provide product images, product names, product codes, materials, colors, sizes, MOQ, categories, collections, catalog guidance, member status notices, and quote request features.', 'The service is a B2B catalog and inquiry flow for trade review. It is not intended for immediate trade confirmation.']],
      ...
      ['Article 6 Product Information and Trade Terms', ['Product images and descriptions are catalog information for trade review and may differ depending on photography, display environment, production timing, and supply conditions.', 'Registered members can view member and market pricing after sign-in. Final inventory, lead time, shipping terms, and export availability are confirmed during quote processing.', 'Information shown on the site or in inquiry screens is reference information and final terms are confirmed separately by Noblesse.']],
      ['Article 7 Nature of Quote Request', ['A quote request is a request for Noblesse to review selected products and quantities.', 'Submitting a quote request does not create a final transaction, contract, or shipping obligation.', 'Final price, available quantity, production availability, lead time, and shipping terms are guided after manager review.']],
      ['Article 8 Prohibited Conduct and Restrictions', ['Submitting false information, using another person account, abnormal access, unauthorized collection of site information, unauthorized copying of images or descriptions, unauthorized sharing of member prices, system misuse, or interference with service operation is prohibited.', 'If such conduct is confirmed, Noblesse may restrict account access, change member status, or hold inquiry processing without prior notice.']],
    ...
    jp: [
      ['第1条 目的', '本規約は、貴族の会員登録、バイヤー審査、商品カタログ閲覧、見積依頼、および関連するB2B案内サービスの利用条件を定めます。'],
      ['第2条 用語の定義', ['利用者とは、サイトにアクセスし、またはサービスを利用するすべての訪問者および会員をいいます。', '会員とは、会員登録手続を通じて情報を提出し、貴族のカタログおよびお問い合わせサービスを利用する個人または事業者担当者をいいます。', '登録バイヤーとは、ログイン後に会員価格、MOQ、見積依頼などの機能を利用できる会員をいいます。', '見積依頼とは、商品、オプション、数量、メモを基準に取引検討を依頼する手続であり、最終取引確定ではありません。']],
      ...
      ['第4条 サービスの提供', ['貴族は商品画像、商品名、商品コード、素材、カラー、サイズ、MOQ、カテゴリー、コレクション、カタログ案内、会員状態案内、見積依頼機能を提供することがあります。', '本サービスはB2B取引検討のためのカタログおよびお問い合わせ機能であり、即時取引確定を目的としません。']],
      ...
      ['第6条 商品情報および取引条件', ['商品画像および説明は取引検討のためのカタログ情報であり、撮影環境、表示環境、生産時期、供給状況によって実物と異なる場合があります。', '登録会員はログイン後に会員価格と市場別価格を確認できます。最終在庫、納期、配送条件、輸出可否は見積処理時に担当者が確認します。', 'サイトまたはお問い合わせ画面に表示される情報は参考情報であり、最終条件は貴族が別途確認します。']],
      ['第7条 見積依頼の性格', ['見積依頼は、会員が選択した商品と数量について貴族に検討を依頼する手続です。', '見積依頼の受付のみで最終取引、契約、配送義務は発生しません。', '最終価格、可能数量、生産可否、納期、配送条件は担当者確認後に案内されます。']],
      ['第8条 禁止行為および制限', ['虚偽情報の提出、第三者アカウントの使用、異常アクセス、サイト情報の無断収集、画像または説明の無断複製、会員価格の無断共有、システムの不正利用、サービス運営の妨害は禁止されます。', '該当行為が確認された場合、貴族は事前通知なくアカウント利用制限、会員状態変更、またはお問い合わせ処理の保留を行うことがあります。']],
      ['第9条 個人情報および通知', ['貴族は会員登録、バイヤー審査、お問い合わせ対応、見積案内に必要な個人情報を、該当する同意および個人情報処理方針に従って処理します。', '会員登録、規約、個人情報、カタログ、見積依頼に関する質問は、サイト案内または指定された連絡窓口を通じて受け付けます。']],
    ],
    cn: [
      ['第1條 目的', '本條款規範貴族會員註冊、買家審核、商品目錄瀏覽、報價詢問及相關 B2B 說明服務的使用條件。'],
      ['第2條 用語定義', ['使用者是指連線至本網站或使用服務的所有訪客與會員。', '會員是指透過會員註冊程序提交資料，並使用貴族目錄及詢問服務的個人或事業負責人。', '已註冊買家是指登入後可使用會員價格、MOQ、報價詢問等功能的會員。', '報價詢問是以商品、選項、數量與備註為基準，請求貴族進行交易審核的程序，並非最終交易確認。']],
      ...
      ['第6條 商品資訊與交易條件', ['商品圖片與說明為交易審核用目錄資訊，可能因拍攝環境、顯示環境、生產時點與供應狀況而與實物不同。', '已註冊會員登入後可查看會員價格與市場別價格。最終庫存、交期、配送條件與出口可否由負責人在詢價處理時確認。', '網站或詢問畫面中顯示的資訊為參考資訊，最終條件由貴族另行確認。']],
      ['第7條 報價詢問性質', ['報價詢問是會員針對所選商品與數量請求貴族審核的程序。', '僅提交報價詢問不會產生最終交易、契約或配送義務。', '最終價格、可供應數量、生產可否、交期與配送條件由負責人確認後提供。']],
      ['第8條 禁止行為與限制', ['禁止提交不實資料、使用他人帳戶、異常存取、未經授權蒐集網站資訊、未經授權複製圖片或說明、未經授權分享會員價格、濫用系統或妨礙服務運作。', '如確認上述行為，貴族得不經事前通知限制帳戶使用、變更會員狀態或保留詢問處理。']],
      ['第9條 個人資訊與通知', ['貴族依相關同意及隱私政策，處理會員註冊、買家審核、詢問回覆及報價說明所需的個人資訊。', '會員註冊、條款、個人資訊、目錄或報價詢問相關問題，可透過網站說明或指定聯絡管道提出。']],
    ],
  },
  buyer_terms: {
    en: [
      ['Article 1 Purpose', 'These terms define detailed standards for Noblesse wholesale member accounts, member price access, MOQ, quote request, and trade terms guidance.'],
      ['Article 2 Member Account', ['Registered wholesale members can use member pricing, MOQ, Inquiry List, and Request Quote after sign-in.', 'Final availability and supply conditions are confirmed by a manager during quote processing.']],
      ['Article 3 Member Status and Access', ['Member status may be divided into guest, active member, restricted member, and admin.', 'Active members may use member pricing and quote features after sign-in. Accounts may be restricted for false information or service misuse.']],
      ['Article 4 Pricing, MOQ, and Options', ['Member price and market-specific price may be shown to signed-in active members.', 'MOQ may vary depending on product, material, color, size, production condition, and market supply policy.', 'Prices may vary depending on currency, country, market, supply terms, export availability, exchange rates, and production conditions.']],
      ['Article 5 Quote Request and Accuracy', ['Quote request is a request for review of selected products and quantities and is not a final transaction or contract.', 'Members must submit accurate information required for account operation and quote support.', 'Account access may be restricted or quote guidance delayed when submitted information is false, incomplete, unreachable, or difficult to verify.']],
      ['Article 6 Price Information Protection', ['Member pricing, market pricing, quote contents, and supply terms are information provided for registered buyer trade review.', 'Members must not share, disclose, or externally use price information or quote contents without prior consent from Noblesse.']],
      ['Article 7 Account Restrictions', 'If inaccurate information, unauthorized price sharing, service misuse, or conduct that harms trade order is confirmed, Noblesse may restrict account or service use.'],
    ],
    jp: [
      ['第1条 目的', '本条件は、貴族の卸バイヤー審査、会員価格へのアクセス、MOQ、見積依頼、取引条件案内に関する詳細基準を定めます。'],
      ['第2条 バイヤー審査', ['貴族は会社名、担当者、連絡先、国・地域、販売チャネル、業態、関心商品、取引適合性を基準に卸バイヤー資格を審査します。', '審査は自動承認ではなく、担当者確認を経て進められます。']],
      ['第3条 会員状態およびアクセス', ['会員状態はゲスト、有効会員、制限会員、管理者などに区分されることがあります。', '有効会員はログイン後に会員価格と見積機能を利用できます。虚偽情報やサービスの不正利用が確認されたアカウントは制限される場合があります。']],
      ['第4条 価格、MOQ、およびオプション', ['会員価格および市場別価格はログイン中の有効会員に表示されることがあります。', 'MOQは商品、素材、カラー、サイズ、生産状況、市場供給方針により異なる場合があります。', '価格は通貨、国、市場、供給条件、輸出可否、為替、製造状況により変動する場合があります。']],
      ['第5条 見積依頼と情報の正確性', ['見積依頼は選択した商品と数量に対する検討依頼であり、最終取引または契約ではありません。', '会員はバイヤー審査に必要な正確な情報を提出しなければなりません。', '提出情報が虚偽、不完全、連絡不能、または確認困難な場合、承認または見積案内が遅延することがあります。']],
      ['第6条 価格情報の保護', ['会員価格、市場別価格、見積内容、供給条件は登録バイヤーの取引検討のために提供される情報です。', '会員は貴族の事前同意なく、価格情報または見積内容を共有、開示、外部利用してはなりません。']],
      ['第7条 アカウント利用制限', '不正確な情報、無断の価格共有、サービスの不正利用、または取引秩序を害する行為が確認された場合、貴族はアカウントまたはサービス利用を制限することがあります。'],
    ],
    cn: [
      ...
      ['第3條 會員狀態與存取', ['會員狀態可分為訪客、有效會員、受限會員與管理者。', '有效會員登入後可使用會員價格與報價功能。如確認不實資料或濫用服務，帳戶可能受到限制。']],
      ['第4條 價格、MOQ 與選項', ['會員價格與市場別價格得向已登入的有效會員顯示。', 'MOQ 可能依商品、材質、顏色、尺寸、生產狀況與市場供應政策而不同。', '價格可能依幣別、國家、市場、供應條件、出口可否、匯率與生產狀況而變動。']],
      ['第5條 報價詢問與資訊正確性', ['報價詢問是針對所選商品與數量的審核請求，並非最終交易或契約。', '會員應提交買家審核所需的正確資訊。', '如提交資訊不實、不完整、無法聯絡或難以確認，核准或報價說明可能延遲。']],
      ['第6條 價格資訊保護', ['會員價格、市場別價格、報價內容與供應條件，是提供給已註冊買家進行交易審核的資訊。', '未經貴族事前同意，會員不得分享、揭露或對外使用價格資訊或報價內容。']],
      ['第7條 帳戶使用限制', '如確認不正確資訊、未經授權分享價格、濫用服務或損害交易秩序的行為，貴族得限制帳戶或服務使用。'],
    ],
  },
  privacy_collection_use: {
    en: [
      ['[Required] Personal Information Collection and Use Consent', {
        ...
        rows: [
          ...
          ['Quote request response and trade terms guidance', 'Contact details, inquiry products, quantity, request memo, manager response record', 'Until inquiry processing is completed and internal record retention period expires'],
    ...
    jp: [
      ['【必須】個人情報の収集・利用同意', {
        ...
        rows: [
          ...
          ['見積依頼対応および取引条件案内', '連絡先、お問い合わせ商品、数量、依頼メモ、担当者対応記録', 'お問い合わせ処理完了後、内部記録保管期間まで'],
          ['不正利用防止およびサービス安定性確保', 'アクセス記録、利用記録、会員状態変更記録', '関連法令または内部セキュリティ基準に基づく期間'],
        ],
      }],
      ['処理および保護原則', ['個人情報は、会員登録審査、バイヤー審査、お問い合わせ対応、記録管理、不正利用防止に必要な範囲でのみ処理されます。', '目的達成後は、法令、紛争対応、セキュリティ基準上の保管が必要な場合を除き、削除または分離保管されます。', '必須同意を拒否する場合、会員申請および見積依頼処理が制限されることがあります。']],
    ],
    cn: [
      ['【必填】個人資訊蒐集及使用同意', {
        type: 'table',

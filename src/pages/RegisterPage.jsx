...
const localizedAgreementSections = {
  terms_of_service: {
    kr: [
      ...
      ['제2조 용어의 정의', ['이용자는 사이트에 접속하거나 서비스를 이용하는 모든 방문자와 회원을 의미합니다.', '회원은 회원 가입 절차를 통해 정보를 제출하고 귀족의 카탈로그 및 문의 서비스를 이용하는 개인 또는 사업자 담당자를 의미합니다.', '승인 회원은 귀족이 거래 가능 여부를 확인한 뒤 회원가, MOQ, 견적 문의 등 일부 기능 접근을 허용한 회원을 의미합니다.', '견적 문의는 상품, 옵션, 수량, 메모를 기준으로 거래 검토를 요청하는 절차이며 최종 주문이나 대금 확정이 아닙니다.']],
      ...
      ['제4조 서비스의 제공', ['귀족은 상품 이미지, 상품명, 상품 코드, 소재, 컬러, 사이즈, MOQ, 카테고리, 컬렉션, 카탈로그 안내, 회원 상태 안내, 견적 문의 관련 기능을 제공할 수 있습니다.', '서비스는 B2B 거래 검토를 돕기 위한 카탈로그 및 문의 기능이며, 온라인 대금 처리나 즉시 주문 확정을 목적으로 하지 않습니다.']],
      ...
      ['제10조 견적 문의의 성격', ['견적 문의는 회원이 관심 상품과 수량을 기준으로 귀족에 검토를 요청하는 절차입니다.', '견적 문의 접수만으로 주문, 계약, 대금 처리나 배송 의무가 발생하지 않습니다.', '최종 가격, 가능 수량, 생산 가능 여부, 납기, 배송 조건은 담당자 확인 후 안내됩니다.']],
  ...
  buyer_terms: {
    kr: [
      ...
      ['제6조 견적 문의', ['견적 문의는 선택한 상품과 수량에 대한 검토 요청입니다.', '견적 문의는 최종 주문, 대금 처리, 계약 체결을 의미하지 않으며, 귀족 담당자의 확인 후 별도 안내됩니다.']],

...
const homeCopy = {
  kr: {
    ...
    approved: '문의 리스트',
    admin: '관리자 미리보기',
    buyerStripGuest: '상품은 먼저 둘러볼 수 있어요',
    buyerStripPending: '회원 확인 중이에요',
    buyerStripApproved: '회원가를 볼 수 있어요',
    buyerStripGuestNote: '가격과 문의 기능은 회원 확인 후 열립니다.',
    buyerStripApprovedNote: '지역 가격이 적용되어 있어요.',
    quickTitle: '빠른 카테고리',
    ...
    supportSmall: '상세 소싱 상담은 견적 문의 이후 이어집니다.',
    companyTitle: '회사 정보',
    companyNote: 'Noblesse Piercing',
    companySmall: '한국 피어싱 도매 카탈로그 / 글로벌 고객 지원',
    brandNoteTitle: '글로벌 고객을 위한 구성',
    brandNoteText: '큰 상품 이미지, 수출 상담에 필요한 정보, 간단한 견적 문의 흐름을 제공합니다.',
  },
  en: {
    eyebrow: 'Korean piercing wholesale catalog',
    title: 'Noblesse Piercing',
    lead: 'A premium piercing catalog for global partners.',
    note: 'Members can access prices and send quote inquiries after review.',
    ...
    supportSmall: 'Detailed sourcing support continues after quote inquiry.',

...
const inquiryListCopy = {
  kr: {
    accessPendingTitle: '거래처 이용 상태 확인이 필요합니다.',
    accessPendingBody: '계정 정보를 확인하거나 담당자에게 문의해주세요.',
    accessGuestTitle: '견적 리스트는 로그인 후 이용할 수 있습니다.',
    accessGuestBody: '로그인하거나 거래처 등록 후 가격과 견적 리스트를 이용해주세요.',
    accountStatus: '계정 상태 보기',
    loadingTitle: '견적 리스트를 준비하고 있습니다.',
    loadingBody: '거래처 정보와 가격을 확인하고 있습니다.',
    ...
    emptyBody: '상품 상세에서 거래처 가격을 확인하고 견적 리스트에 담아주세요.',
  ...
  en: {
    accessPendingTitle: 'Buyer account status needs attention.',
    accessPendingBody: 'Please check the account information or contact Noblesse.',
    accessGuestTitle: 'Inquiry List is available after sign-in.',
    accessGuestBody: 'Please sign in or register a buyer account to use prices and Inquiry List.',
    accountStatus: 'View account status',
    loadingTitle: 'Preparing your Inquiry List.',
    loadingBody: 'Checking buyer information and prices.',
    ...
    emptyBody: 'Open a product detail page and add buyer-priced items to the Inquiry List.',
  ...
  jp: {
    accessPendingTitle: '取引先アカウントの確認が必要です。',
    accessPendingBody: 'アカウント情報を確認するか、担当者へお問い合わせください。',
    accessGuestTitle: '見積もりリストはログイン後に利用できます。',
    accessGuestBody: 'ログインまたは取引先登録後、価格と見積もりリストをご利用ください。',
    accountStatus: 'アカウント状態を見る',
    loadingTitle: '見積もりリストを準備しています。',
    loadingBody: '取引先情報と価格を確認しています。',
    ...
    emptyBody: '商品詳細で取引先価格を確認し、見積もりリストに追加してください。',
  ...
  cn: {
    accessPendingTitle: '需要確認買家帳戶狀態。',
    accessPendingBody: '請確認帳戶資料或聯絡 Noblesse。',
    accessGuestTitle: '登入後可使用詢價清單。',
    accessGuestBody: '請登入或註冊買家帳戶後使用價格與詢價清單。',
    accountStatus: '查看帳戶狀態',
    loadingTitle: '正在準備詢價清單。',
    loadingBody: '正在確認買家資料與價格。',
    ...
    emptyTitle: '尚未加入商品。',
    emptyBody: '請在商品詳情頁確認買家價格後加入詢價清單。',
    browseProducts: '查看商品',
    product: '商品',
    condition: '交易條件',
    quantity: '數量',

...
function AccessNotice({ viewerState }) {
  ...
  return <main className="content"><div className="approval-page"><LockKeyhole size={25} /><h1>{isPending ? '회원 확인 중입니다.' : '문의 리스트는 회원 확인 후 이용할 수 있습니다.'}</h1><p>{isPending ? '가격, 합계, 견적 문의 기능은 확인 후 열립니다.' : '로그인하거나 회원 신청 후 가격과 문의 리스트를 이용해주세요.'}</p><Link to={toLocalePath('/account')}>회원 상태 보기</Link></div></main>
}

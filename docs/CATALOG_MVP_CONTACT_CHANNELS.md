# Catalog MVP Contact Channels

## Purpose

- Catalog MVP에서 실제 문의가 들어올 수 있는 채널을 정리합니다.
- Backend/API 자동화 전 수동 follow-up 기준을 확정합니다.
...
- Use 거래 문의 / 제품 문의 / 견적 문의.
- Make clear that inquiry is not final order.
- Avoid checkout/payment/cart language.

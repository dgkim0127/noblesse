...
test('quote workflow separates customer documents from internal notes and direct payment', () => {
  ...
  assert.match(adminQuote, /admin-pc-picking-sheet/)
  assert.match(adminQuote, /admin-picking-sheet-progress/)
  assert.match(adminQuote, /admin-picking-kpis/)
  assert.match(adminQuote, /<progress/)
  assert.match(adminQuote, /pickingSummary/)

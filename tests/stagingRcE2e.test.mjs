...
function validEnv(overrides = {}) {
  return {
    ...
    VITE_API_BASE_URL: "https://staging-api.example.internal",
...
test("staging RC env validation normalizes a safe staging API URL", () => {
  const config = validateStagingRcEnv(validEnv({ VITE_API_BASE_URL: "https://staging-api.example.internal/" }));

  assert.equal(config.apiBaseUrl, "https://staging-api.example.internal");
